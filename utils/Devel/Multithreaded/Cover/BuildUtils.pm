...
package Devel::Multithreaded::Cover::BuildUtils;
...
sub nice_cpus {
    $ENV{DEVEL_MULTITHREADED_COVER_CPUS} || do {
        my $cpus = cpus;
        $cpus-- if $cpus > 3;
        $cpus-- if $cpus > 6;
        $cpus
...
Devel::Multithreaded::Cover::BuildUtils - Build utility functions for Devel::Multithreaded::Cover

=head1 SYNOPSIS

 use Devel::Multithreaded::Cover::BuildUtils "find_prove";

=head1 DESCRIPTION

Build utility functions for Devel::Multithreaded::Cover.

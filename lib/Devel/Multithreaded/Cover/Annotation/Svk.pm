...
package Devel::Multithreaded::Cover::Annotation::Svk;
...
sub new {
    my $class = shift;
    my $annotate_arg = $ENV{DEVEL_MULTITHREADED_COVER_SVK_ANNOTATE} || "";
    my $self = {
...
Devel::Multithreaded::Cover::Annotation::Svk - Annotate with svk information

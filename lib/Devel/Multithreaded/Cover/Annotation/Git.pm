...
package Devel::Multithreaded::Cover::Annotation::Git;
...
sub new {
    my $class = shift;
    my $annotate_arg = $ENV{DEVEL_MULTITHREADED_COVER_GIT_ANNOTATE} || "";
    my $self = {
...
Devel::Multithreaded::Cover::Annotation::Git - Annotate with git information

# This file is part of Devel::Multithreaded::Cover.
...
package  # Private module
   Devel::Multithreaded::Cover::Dumper;
...
sub import {
    ...
    if (defined &{"${caller}::Dumper"} && \&{"${caller}::Dumper"} != \&Dumper) {
        ...
        Carp::croak("Data::Dumper previously imported.  " .
                    "Use Devel::Multithreaded::Cover::Dumper instead.");
    }
...
Devel::Multithreaded::Cover::Dumper - Internal module for debugging purposes

...
package Devel::Multithreaded::Cover::Condition;
...
use base "Devel::Multithreaded::Cover::Branch";
...
Devel::Multithreaded::Cover::Condition - Code coverage metrics for Perl

...
package Devel::Multithreaded::Cover::Collection;
...
use Devel::Multithreaded::Cover::DB::IO::JSON;
            ...
            while (<$fh>) {
                ...
                if ($printed < $non_buffered) {
                    ...
                    if (($printed += length) >= $non_buffered) {
                        say "Devel::Multithreaded::Cover: buffering ...";
                    }
...
sub run {
    ...
    my @cmd;
    if ($self->local) {
        $ENV{DEVEL_MULTITHREADED_COVER_OPTIONS} = "-ignore,/usr/local/lib/perl5";
        $ENV{DEVEL_MULTITHREADED_COVER_TEST_OPTS} = "-Mblib=" . $self->bin_dir;
        @cmd = ($^X, $ENV{DEVEL_MULTITHREADED_COVER_TEST_OPTS}, $self->bin_dir . "/cover");
    } else {
...
sub write_json {
    ...
    my $io = Devel::Multithreaded::Cover::DB::IO::JSON->new(options => "pretty");
...
sub generate_html {
    ...
    my $vars = {
        ...
        headers  => [ grep !/path|time/,
                           @Devel::Multithreaded::Cover::DB::Criteria_short, "total" ],
        criteria => [ grep !/path|time/,
                           @Devel::Multithreaded::Cover::DB::Criteria,       "total" ],
    };
    ...
    my $template = Template->new({
        LOAD_TEMPLATES => [
            Devel::Multithreaded::Cover::Collection::Template::Provider->new({}),
        ],
    });
...
sub write_stylesheet {
    ...
    print $fh <<EOF;
/* Stylesheet for Devel::Multithreaded::Cover collection reports */
...
package Devel::Multithreaded::Cover::Collection::Template::Provider;
...
<!--
This file was generated by Devel::Multithreaded::Cover Version $VERSION
Devel::Multithreaded::Cover is copyright 2001-2018, Paul Johnson (paul\@pjcj.net)
Devel::Multithreaded::Cover is free. It is licensed under the same terms as Perl itself.
The latest version of Devel::Multithreaded::Cover should be available from my homepage:
http://www.pjcj.net
-->
[% PROCESS colours %]
<head>
...
<body>
    ...
    <hr/>
    <p>
    Coverage information from <a href="https://metacpan.org/module/Devel::Multithreaded::Cover">
...
href="https://metacpan.org/release/Devel-Multithreaded-Cover">Devel::Multithreaded::Cover</a>.
...
<p>The source code is available at the
  ...
  <a href="http://pjcj.net/devel-multithreaded-cover/projects.html">open projects</a>.
</p>
...
Devel::Multithreaded::Cover::Collection - Code coverage for a collection of modules

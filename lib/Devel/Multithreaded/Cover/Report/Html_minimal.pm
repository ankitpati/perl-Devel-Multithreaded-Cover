package Devel::Multithreaded::Cover::Report::Html_minimal;
BEGIN {require 5.006}
use strict;
use warnings;
use HTML::Entities;
...
use Devel::Multithreaded::Cover::Html_Common "launch";
...
sub truth_table {
    ...
    foreach my $c (@_) {
        ...
        my $t = {
            ...
            # tt   => Devel::Multithreaded::Cover::Truth_Table->new_primitive($op, $c, $n++);
            cvg  => $c->[1],
...
sub _condition_report {
    my $coverage = shift;
    # use Devel::Multithreaded::Cover::Dumper; print STDERR Dumper $coverage;
...
Devel::Multithreaded::Cover::Report::Html_minimal - HTML backend for Devel::Multithreaded::Cover
...
__DATA__
/* Stylesheet for Devel::Multithreaded::Cover HTML reports */

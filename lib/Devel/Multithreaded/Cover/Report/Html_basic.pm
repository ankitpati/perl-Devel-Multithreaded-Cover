...
package Devel::Multithreaded::Cover::Report::Html_basic;
...
use Devel::Multithreaded::Cover::Web "write_file";
...
sub print_conditions {
    ...
    # use Devel::Multithreaded::Cover::Dumper; print Dumper \@types;
...
sub report {
    ...
    $Template = Template->new({
        LOAD_TEMPLATES => [
            Devel::Multithreaded::Cover::Report::Html_basic::Template::Provider->new({}),
        ],
    });
...
package Devel::Multithreaded::Cover::Report::Html_basic::Template::Provider;
...
<!--
This file was generated by Devel::Multithreaded::Cover Version [% R.version %]
...
Devel::Multithreaded::Cover::Report::Html_basic - HTML backend for Devel::Multithreaded::Cover

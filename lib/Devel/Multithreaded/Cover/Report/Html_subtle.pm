package Devel::Multithreaded::Cover::Report::Html_subtle;
use strict;
use warnings;
...
sub report {
    ...
    $Template = Template->new({
        LOAD_TEMPLATES => [Devel::Multithreaded::Cover::Report::Html_subtle::Template::Provider->new({}),],
    });
...
package Devel::Multithreaded::Cover::Report::Html_subtle::Template::Provider;
use strict;
use warnings;
...
Devel::Multithreaded::Cover::Report::Html_subtle - HTML backend for Devel::Multithreaded::Cover

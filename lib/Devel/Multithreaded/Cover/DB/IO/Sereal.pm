...
package Devel::Multithreaded::Cover::DB::IO::Sereal;
...
Devel::Multithreaded::Cover::DB::IO::Sereal - Sereal based IO routines for Devel::Multithreaded::Cover::DB

=head1 SYNOPSIS

 use Devel::Multithreaded::Cover::DB::IO::Sereal;

 my $io = Devel::Multithreaded::Cover::DB::IO::Sereal->new;
 my $data = $io->read($file);
 $io->write($data, $file);

=head1 DESCRIPTION

This module provides Sereal based IO routines for Devel::Multithreaded::Cover::DB.

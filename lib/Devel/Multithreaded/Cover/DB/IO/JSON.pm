...
package Devel::Multithreaded::Cover::DB::IO::JSON;

use strict;
use warnings;

use base "Devel::Multithreaded::Cover::DB::IO::Base";
...
Devel::Multithreaded::Cover::DB::IO::JSON - JSON based IO routines for Devel::Multithreaded::Cover::DB
...
This module provides JSON based IO routines for Devel::Multithreaded::Cover::DB.

=head1 SEE ALSO

L<Devel::Multithreaded::Cover>
L<JSON::MaybeXS>

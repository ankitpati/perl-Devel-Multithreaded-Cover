...
package Devel::Multithreaded::Cover::DB::Structure;
...
sub AUTOLOAD {
    ...
    croak "Undefined subroutine $func called"
        unless $criterion &&
               grep $_ eq $criterion, @Devel::Multithreaded::Cover::DB::Criteria,
...
sub digest {
    ...
    if (open my $fh, "<", $file) {
        ...
        print STDERR "Devel::Multithreaded::Cover: Warning: can't open $file " .
                                             "for MD5 digest: $!\n"
            unless lc $file eq "-e" or
                      $Devel::Multithreaded::Cover::Silent or
...
sub read {
    ...
    if (!$d) {
        ...
        print STDERR "Devel::Multithreaded::Cover: Deleting old coverage ",
        ...
        if (unlink $file) {
            ...
            print STDERR "Devel::Multithreaded::Cover: can't delete $file: $!\n";
...
sub merge {
    my $self   = shift;
    my ($from) = @_;
    Devel::Multithreaded::Cover::DB::_merge_hash($self->{f}, $from->{f}, "noadd");
}
...
Devel::Multithreaded::Cover::DB::Structure - Internal: abstract structure of a source file

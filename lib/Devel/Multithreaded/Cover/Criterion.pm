...
package Devel::Multithreaded::Cover::Criterion;
...
use Devel::Multithreaded::Cover::Branch;
use Devel::Multithreaded::Cover::Condition;
use Devel::Multithreaded::Cover::Condition_or_2;
use Devel::Multithreaded::Cover::Condition_or_3;
use Devel::Multithreaded::Cover::Condition_and_2;
use Devel::Multithreaded::Cover::Condition_and_3;
use Devel::Multithreaded::Cover::Condition_xor_4;
use Devel::Multithreaded::Cover::Subroutine;
use Devel::Multithreaded::Cover::Time;
use Devel::Multithreaded::Cover::Pod;
...
Devel::Multithreaded::Cover::Criterion - Code coverage metrics for Perl
